// import { Scrollbar } from "smooth-scrollbar/npm install smooth-scrollbar";
...
//     var message = "¡¿Pa' eso entras?! :( ♥";
//     var original = "NERD - Digital Minds";
...
$(".contenido .text span").hover(function () {
...
MyApp = {
    ...
    categoria: {
        init: function () {
            ...
            const itemsportfolio = document.querySelectorAll(".gallery__item.mostrarVermas")
            enlaces.forEach((elemento) => {
                elemento.addEventListener('click', (evento) => {
                    ...
                    if (categoria == "Todo") {
                        ...
                        for (let i = 0; i < itemsportfolio.length; i++) {             
                            if (itemsportfolio[i].classList.contains(categoria)) {
                    ...
                    if (categoria == "Diseño Web") {
                        for (let i = 0; i < itemsportfolio.length; i++) {                            
                            console.log(itemsportfolio[i].attributes[1].textContent);
                            if (itemsportfolio[i].classList.contains("DiseñoWeb")) {
                                itemsportfolio[i].style.display = "block";
                            }else{
                                itemsportfolio[i].style.display = "none";
                            }
...
document.addEventListener("click", function (e) {
    ...
    if (e.target.closest(".contacto-page") || e.target.closest(".contenido .text span")) {
